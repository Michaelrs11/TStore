...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Update your Store</div>
                ...
                <div class="card-body">
                        ...
                        <form action="{{ route('store.update', ['id'=>$editData]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                             ...
                             <div class="col-md-6">
                               <textarea id="description" name="description" class="form-control" row="3" >
